...
#    Updated: 2020/01/04 12:06:58 by Kay Zhou         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
if __name__ == "__main__":
    ...
    # window user file
    # save_user_snapshot(start, end, w=14, prob=0.66)
    ...
    # predict_user_before_PASO(p=0.6)
    # predict_user_before_PASO(p=0.65)
    # predict_user_before_PASO(p=0.7)
    # predict_user_before_PASO(p=0.75)
    # predict_user_before_PASO(p=0.68)
