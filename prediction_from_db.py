...
def calculate_cumulative_share(start, end, super_start_month="01", p=0.5, save_users=True):
    """VIP 2
...
if __name__ == "__main__":
    ...
    calculate_cumulative_share(start, end, super_start_month="01", p=0.7, save_users=True)
    # -- cumulative end --
